...
exports.createRoom = async (req, res) => {
  try {
    ...
    console.log('📝 Creating room:', { name, roomType, duration, userId: req.userId });
    ...
    console.log('✅ Room created:', { roomId: room.room_id, qrCode, burnerUsername });
...
exports.getRoomMembers = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      'SELECT burner_username, joined_at FROM room_members WHERE room_id = $1 ORDER BY joined_at ASC',
      [roomId]
    );
