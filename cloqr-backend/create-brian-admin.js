...
async function createBrianAdmin() {
  try {
    ...
    const result = await pool.query(
      ...
      [
        ...
        'Brian Admin',
        'Admin',
        'https://api.dicebear.com/7.x/avataaars/svg?seed=brianadmin',
        passwordHash,
        'dating'
      ]
    );
    ...
    console.log('');
    console.log('You can now login using these credentials in the app');
